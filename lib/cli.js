(function () {
    ...
    var notSources = {};
    var watchedDirs = {};
    program.version(packagejson.version).usage('[options] <scripts ...>').option('-b, --bare', 'compile without a top-level function wrapper').option('-r, --repl', 'start an interactive FancyScript REPL').option('-o, --out <directory>', 'set output directory', String).option('-w, --watch', 'watch for file changes').parse(process.argv);
